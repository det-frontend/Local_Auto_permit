  ...
  return (
    <header id='Header' ref={headerRef} className='fixed  bg-white  top-0 left-0 right-0  z-50   flex items-center justify-center  bg-transparent drop-shadow-md'>
          ...
          <div className='text-lg font-bold pt-3 mb-2'>
            <Link className='flex justify-center items-center gap-2' to={!show?"/user/choose":"/kyawsan/home"}><img className=' w-[50px] h-[50px]' src={Logo} alt='logo' /> 
              <div>
         ...
         show &&  legit ? <ul className='flex  w-[55%] items-center justify-start text-sm gap-10'>
              ...
              <Link to={user.name === "kyaw san"?"kyawsan/dailysalereport":"kyawsan/dailysalereport"} className='bg-blue-900 text-white px-3 py-2 rounded-lg'> <li>Detail Sales</li></Link>
