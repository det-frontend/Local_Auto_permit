...
function SideNavBar({setFuelIn,setIsMenu,isMenu,data,setData}) {
  ...
  return (
    ...
    <div className={` p-3 duration-100  bg-white drop-shadow-xl ease-linear h-[89svh] sticky bottom-0 left-0 top-[65px] ${isMenu?'w-[150px]':'w-[70px]'}`}>
      
      <p onClick={() => setIsMenu((prev) => !prev)} className='border-2 mt-[50px] hover:rounded duration-500 hover:shadow  text-3xl cursor-pointer'>
        {
